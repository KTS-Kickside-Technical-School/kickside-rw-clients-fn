...
import { staffGetSingleArticle, staffToggleArticlePublish, staffDeleteArticle } from "../../utils/requests/articlesRequest";
                ...
                {isLoading ? (
                    ...
                    <>
                        ...
                        <div className="mb-8 space-y-4">
                            ...
                            <div
                                className={`flex items-center text-gray-700 ${article?.status === "published"
                        ...
                        <div>
                            <h2 className="text-xl font-semibold mb-4 text-gray-800">Cover image:</h2>
                            <img
