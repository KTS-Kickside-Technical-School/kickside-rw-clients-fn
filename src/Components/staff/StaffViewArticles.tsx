...
const StaffViewArticles = ({ profile }: any) => {
    ...
    const [isEditRequestsOpen, setIsEditRequestsOpen] = useState(false);
        ...
        <div className="p-6 bg-gray-50 min-h-screen">
            ...
            <div className="max-w-8xl mx-auto">
                <div className="flex justify-between items-center mb-6">
                    <h1 className="text-3xl font-bold text-gray-900">{isEditRequestsOpen ? ("Article Edit Requests") : ("Articles list")}</h1>
                    <Link
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 mb-6">
                    ...
                    {(profile?.role === "Admin" || profile?.role === "Editor") && (
                        <div className="px-5 py-2">
                            <button
                                onClick={() => setIsEditRequestsOpen((prev) => !prev)}
                                className="inline-flex items-center px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg transition shadow-sm"
                            >
                                <FiEdit />
                                <span className="mx-2">Edit requests</span>
                            </button>
                        </div>
                    )}
                    {error && (
