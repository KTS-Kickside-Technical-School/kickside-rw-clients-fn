        ...
        <footer className="bg-dark text-white py-6 flex flex-col items-center gap-6">
            <div className="w-80% flex flex-col md:flex-row md:justify-between items-center gap-4 px-6">
                ...
                <ul className="flex flex-wrap justify-center gap-4">
                    <li><Link to="/staff/login" aria-label='Staff' target="_blank" className="font-bold hover:underline">Staff</Link></li>
            ...
            <div className="flex flex-wrap justify-center gap-6">
                <Link to="https://www.instagram.com/kickside_rw/" target="_blank" aria-label="Instagram" className="hover:text-gray-300">
                    <BsInstagram size={24} />
                </Link>
                <Link to="https://www.youtube.com/@KicKSideRw" target="_blank" aria-label="YouTube" className="hover:text-gray-300">
                    <BsYoutube size={24} />
                </Link>
                <Link to="https://www.linkedin.com/company/kickside-rwanda/?viewAsMember=true" target="_blank" aria-label="LinkedIn" className="hover:text-gray-300">
                    <BsLinkedin size={24} />
                </Link>
                <Link to="https://x.com/KickSide_RW" target="_blank" aria-label="Twitter" className="hover:text-gray-300">
                    <BsTwitterX size={24} />
                </Link>
            </div>
