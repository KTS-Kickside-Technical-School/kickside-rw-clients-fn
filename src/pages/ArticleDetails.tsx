...
import { getPublishedArticles, getSingleArticle, postComment } from '../utils/requests/articlesRequest';
            ...
            <div className="bg-gray-100 min-h-screen">
                ...
                <div className="flex flex-col lg:flex-col w-[90%] lg:w-[80%] mx-auto gap-8">
                    ...
                    <div className="bg-gray-100 rounded-lg mt-6">
                        <h2 className="text-2xl font-semibold border-b-2 border-dark pb-2 mb-4">Conversation</h2>
                        {isCommentsLoading ? (
                            ...
                            <div className="flex items-center justify-center p-4 bg-gray-100 border border-gray-300 rounded-lg shadow-md max-w-md mx-auto">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-blue-500 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 10h.01M12 10h.01M16 10h.01M21 14.5A3.5 3.5 0 0117.5 18H6.5A3.5 3.5 0 013 14.5v-5A3.5 3.5 0 016.5 6h11A3.5 3.5 0 0121 9.5v5z" />
                                </svg>
                                <p className="text-gray-700 text-lg">No comments yet. Be the first to comment!</p>
                            </div>
