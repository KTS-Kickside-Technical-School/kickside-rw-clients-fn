            ...
            <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
                {isMailSent ? (
                    <div className="text-center space-y-4">
                        <AiOutlineCheckCircle size={48} className="text-green-500 mx-auto" />
                        <h1 className="text-2xl font-bold text-gray-800">Verification Email Sent!</h1>
                        <p className="text-gray-500 text-sm">
                            Please check your email for a verification link. If you don’t see it in your inbox, check your spam folder.
                        </p>
                        <button
                    ...
                    <>
                        <div className="flex flex-col items-center mb-6">
                            ...
                            <p className="text-gray-500 text-sm">Did you forget your password? You are in the right place!</p>
                        </div>
