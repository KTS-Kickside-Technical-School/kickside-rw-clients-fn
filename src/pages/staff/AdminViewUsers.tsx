...
const AdminViewUsers = ({ profile }: { profile: any }) => {
    ...
    const sortedUsers = [...filteredUsers].sort((a, b) => {
        if (sortOption === "Date Joined") return b.createdAt.localeCompare(a.createdAt);
                                            ...
                                            {displayedUsers.map((user, index) => (
                                                <tr key={user._id} className="hover:bg-gray-50 transition-colors">
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                        {user.isDisabled ? (
                                                            <span className="flex text-red-600">
                                                                ...
                                                                <span>
                                                                    Disabled <strong>"{user.disableReason}"</strong>
                                                                </span>
                                                            </span>
                                                        ) : (
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                        <Link to={`/staff/user/${user._id}`} className="text-indigo-600">
                                                            <FiEye />
                                                        </Link>
                                                    </td>
                                                </tr>
