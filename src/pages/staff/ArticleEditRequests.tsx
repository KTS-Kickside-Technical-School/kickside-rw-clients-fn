...
import { getArticleEditRequests, approveEditRequest } from "../../utils/requests/articlesRequest"; // Adjust the import based on your actual requests
...
const ArticleEditRequests = () => {
    ...
    const displayedRequests = editRequests.slice(offset, offset + requestsPerPage);
                                ...
                                {displayedRequests.map((article: any, index) => (
                                    <tr key={article._id} className="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="text-sm font-medium text-gray-900">{article.article.title}</div>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="text-sm text-gray-900">{article.journalist.firstName}{" "}{article.journalist.lastName}</div>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
