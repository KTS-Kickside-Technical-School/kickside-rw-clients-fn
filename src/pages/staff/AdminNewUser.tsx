...
const createUserSchema = Yup.object({
    ...
    role: Yup.string().oneOf(['Journalist', 'Editor', 'Admin'], 'Invalid role').required("Role is required"),
});
                ...
                {({ isSubmitting }) => (
                    <Form>
                        ...
                        <div className="mb-4">
                            ...
                            <Field as="select" name="role" className="w-full p-2 border border-primary outline-0 rounded-md">
                        ...
                        <div className="flex justify-center mt-6">
                            <button
                                ...
                                className={`w-40 py-2 rounded-md text-white ${isSubmitting ? "bg-gray-400" : "bg-blue-500 hover:bg-blue-600"}`}
                            >
