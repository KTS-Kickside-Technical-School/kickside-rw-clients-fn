...
import { userUpdateProfile, userViewProfile } from "../../utils/requests/authRequest";
...
const Settings = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg">
            <SEO title="My Profile - Kickside Rwanda Staff" />
            <ToastContainer />
            {loadingProfile ? (
                    ...
                    <div className="mt-16">
                        ...
                        <div className="flex">
                            ...
                            <div className="flex-1 pl-3">
                                <label className="block text-sm font-semibold text-gray-600">Rank</label>
                                <div className="mt-1 p-2 border rounded-md w-full bg-gray-100 cursor-not-allowed text-gray-700 flex items-center">
                        ...
                        <div className="mt-6 flex justify-end">
                            <button
                                ...
                                className={`px-6 py-2 rounded-lg flex items-center justify-center gap-2 ${saving
