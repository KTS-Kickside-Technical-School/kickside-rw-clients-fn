          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 ">
            <div>
              ...
              <p className="text-black mb-8">
                Please <a href='' className='underline'>complete this form </a>and an account executive will get back to you quickly.
              </p>
            ...
            <div className="lg:w-80 lg:mx-32 ">
              ...
              <div className=" border-4 border-blue-700 bg-[#D8D8D8]  h-96  p-4  w-[303] ">
                <p className="text-center mt-32 text-gray-700 ">Advertisement</p>
              </div>
              <MostPopular />
            </div>
          </div>
