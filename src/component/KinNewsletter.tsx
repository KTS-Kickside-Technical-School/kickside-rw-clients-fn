      ...
      <div className="container mx-auto px-6">
        <div className="max-w-lg mx-auto text-center text-white">
          <h2 className="text-3xl sm:text-2xl font-semibold mb-3 animate-fade-in">
            Iyandikishe Ku ikinyamakuru cyacu
          </h2>
          <p className="text-sm mb-6 animate-fade-in delay-200">
          Komeza uhabwe amakuru mashya ya Kickside. Ushobora kubihagarika igihe icyo ari cyo cyose .
          </p>
