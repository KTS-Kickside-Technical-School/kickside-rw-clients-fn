    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between px-4 md:px-8 py-4 gap-4 overflow-hidden">
        <div className="flex items-center gap-4">
          <img
            src="/logo.svg"
            alt="Ikirango cya Kickside Shop"
          ...
          <div className="overflow-hidden">
            ...
            >
              💸 Kickside Shop – Ibiciro byihariye!
            </motion.h2>
            <motion.p
            ...
            >
              Sagura kugeza kuri{' '}
              <span className="text-emerald-600 font-extrabold">50%</span> ku
              bikoresho bya elegitoroniki, imyambaro n'ibindi – Uyu munsi gusa!
            </motion.p>
          </div>
        </div>
